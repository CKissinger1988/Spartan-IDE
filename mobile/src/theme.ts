...
export const C_DARK = {
  ...
  accent: '#F03133',
  accentDim: '#AF3536',
  accentBg: 'rgba(240,49,51,0.14)',
  accentBorder: 'rgba(240,49,51,0.4)',
  gold: '#AC9C9C',
  goldDim: '#5E5D5D',
  goldBg: 'rgba(172,156,156,0.14)',
  goldBorder: 'rgba(172,156,156,0.4)',
  green: '#4E9E72',
...
export const C_LIGHT = {
  ...
  accent: '#A92327',
  accentDim: '#7C1A1D',
  accentBg: 'rgba(169,35,39,0.10)',
  accentBorder: 'rgba(169,35,39,0.35)',
  gold: '#5E5D5D',
  goldDim: '#3B3A3A',
  goldBg: 'rgba(94,93,93,0.10)',
  goldBorder: 'rgba(94,93,93,0.35)',
  green: '#4E9E72',
  greenBg: 'rgba(78,158,114,0.13)',
  amber: '#C99A3D',
  amberBg: 'rgba(201,154,61,0.13)',
