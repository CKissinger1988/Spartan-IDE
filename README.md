...
- **GUI Builder**: desktop-only visual JSX/TSX design mode with a structural component tree,
  ...
  deletion, duplication, Shift-click multi-selection with synchronized canvas highlights and batch prop/style edits, typed string/number/boolean prop editing, open-tab component file switching,
