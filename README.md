...
- **GUI Builder**: desktop-only visual JSX/TSX design mode with a structural component tree,
  ...
  responsive viewport presets and zoom, searchable component-library discovery/imports with child/sibling placement, member-expression component insertion such as `UI.Button`, searchable image/font asset and design-token
