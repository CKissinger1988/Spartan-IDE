...
- **GUI Builder**: desktop-only visual JSX/TSX design mode with a structural component tree,
  ...
  discovery/insertion, CSS design-token discovery/application/definition/removal from live buffers and disk plus copyable `var(--token)` references, component insertion, reparenting,
