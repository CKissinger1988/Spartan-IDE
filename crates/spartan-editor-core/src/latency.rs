...
/// copy, §47.1/§47.9) so every spike/crate in this workspace reports
/// latency in the same, directly-comparable format.
...
/// Promoted from `spikes/render-spike/src/latency.rs` (§39.1, §47.9)
/// verbatim. Measures real input-to-photon latency: wall-clock time from a
