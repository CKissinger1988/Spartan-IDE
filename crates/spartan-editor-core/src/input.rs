...
/// Promoted from `spikes/render-spike/src/input.rs` (§39.1, §47.9) verbatim.
...
/// reshape suffices or a full reshape is needed.
pub fn handle_key_event(editor: &mut EditorView, event: &KeyEvent) -> EditEffect {
    ...
    match &event.logical_key {
        ...
        _ => {
            ...
            // this crate wants rather than hand-rolling a keycode table.
