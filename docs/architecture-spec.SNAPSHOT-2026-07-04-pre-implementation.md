> **FROZEN SNAPSHOT — 2026-07-04, taken immediately before implementation work began.**
> This is a point-in-time copy (74 sections) preserved as the reference the initial build was
> scored against. `docs/architecture-spec.md` is the **living** spec and keeps evolving — this
> file does not. Don't edit this file; amend the living spec instead.
>
> **One deliberate exception**: §52's old product name (which combined "Spartan" and "AI" into
> one word, before this project's current naming) was updated at explicit user request, as part
> of a full-repo branding scrub. No other content in this file was touched.
