...
| Component palette usage inspection with line-level Editor navigation | Real |
...
| Atomic multi-property style/prop clipboard paste across selections | Real |
...
| Typed prop values for inserted components (number, boolean, and parsed expression) | Real |
...
| Role-aware keyboard accessibility findings and decorative-image alt handling | Real |
...
| Standalone runnable HTML export of the bundled live preview | Real |
